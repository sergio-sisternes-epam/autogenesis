...
1. Bind subject; process root = subject Atlas (`<subject>/references/atlas/`; when subject is autogenesis: `.atlas/github.com/sergio-sisternes-epam/autogenesis-atlas/atlas` after mount).
