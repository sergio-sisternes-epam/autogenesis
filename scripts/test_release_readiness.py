...
class ReleaseReadinessTests(unittest.TestCase):
    ...
    def test_mismatched_skill_version_is_rejected(self) -> None:
        ...
        self.assertEqual(version, "0.4.1")
        self.assertTrue(any("skill frontmatter version 0.4.2" in item for item in errors))
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            changelog.write_text(
                changelog.read_text(encoding="utf-8").replace(
                    "[0.4.1]: https://github.com/sergio-sisternes-epam/"
                    "autogenesis/releases/tag/v0.4.1\n",
                    "",
                ),
                encoding="utf-8",
            )
