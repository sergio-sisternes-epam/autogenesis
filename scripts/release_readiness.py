#!/usr/bin/env python3
"""Validate Autogenesis release metadata against one package version."""
...
SURFACES = (
    ...
    VersionSurface(
        ...
        rf"^- \*\*Package version:\*\* e\.g\. autogenesis v({SEMVER})\s*$",
    ),
    VersionSurface(
...
def main(argv: list[str] | None = None, root: Path = ROOT) -> int:
    ...
    fields: dict[str, str] = {
        ...
        "release_metadata_decision": "blocked" if errors else "pass",
    }
    if args.tag:
