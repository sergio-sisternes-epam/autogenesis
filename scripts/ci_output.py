...
def emit_annotation(
    ...
    *,
    ...
    print(f"{level}: {message}", file=destination)
    ...
    print(
        f"::{level}{suffix}::{_escape_data(annotation)}",
        file=destination,
    )
...
def emit_error(
    ...
    *,
    ...
    emit_annotation("error", message, title=title, file=file, stream=stream)
...
def emit_warning(
    ...
    *,
    ...
    emit_annotation("warning", message, title=title, file=file, stream=stream)
